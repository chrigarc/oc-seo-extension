<?php return [
    ...
    'editor' => [
        ...
        'og_image_comment' => 'An image URL which should represent your object within the graph.',
        'og_type' => 'Open Graph Type',
        'other_og_tags' => 'Other Open Graph meta tags',
        'other_og_tags_comment_above' => 'Insert tags that you want to insert in all pages',
        'other_og_tags_comment' => 'Insert other meta tags like meta author, meta viewport etc',
    ],
    'settings' => [
        'label' => 'SEO Extension',
